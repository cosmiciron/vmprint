...
const AI_GENERATED_FIXTURE_IDS: ReadonlySet<string> = new Set([
    'daily-dispatch',
    'policy-brief',
    'financial-report',
    'financial-report-opener',
    'literary-journal'
]);
...
const BUILTIN_FIXTURES: FixturePreset[] = [
    {
        id: 'financial-report',
        label: 'Financial Report (AI-generated)',
        description: 'A Q4 financial report with cover page, KPI zone-map, revenue trend, executive summary with drop cap, income statement table, and balance sheet — generated by Claude.',
        scriptFile: 'financial-report.js'
    },
    {
        id: 'daily-dispatch',
    ...
    {
        id: 'policy-brief',
        label: 'Policy Brief (AI-generated)',
        description: 'A policy brief on algorithmic governance in public services — generated by Claude. Features drop cap, multi-column story, comparative table, callout quote, and running headers.',
        scriptFile: 'policy-brief.js'
    },
    {
        id: 'financial-report-opener',
        label: 'Annual Report Opener (AI-generated)',
        description: 'An annual report opening with metrics zone, two-column CEO letter with drop cap, and segment performance table — generated by Claude.',
        scriptFile: 'financial-report-opener.js'
    },
    {
        id: 'literary-journal',
        label: 'Literary Journal (AI-generated)',
        description: 'A literary journal issue opening — fiction in three columns with drop cap and full-width pull quote — generated by Claude.',
        scriptFile: 'literary-journal.js'
    },
    {
