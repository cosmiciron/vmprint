# AST JSON to PDF with Web Fonts (Static Browser Example)
...
- `docs/examples/ast-to-pdf-webfonts/assets/vmprint-engine.js`
- `docs/examples/ast-to-pdf-webfonts/assets/vmprint-web-fonts.js`
- `docs/examples/ast-to-pdf-webfonts/assets/vmprint-context-pdf-lite.js`
- `docs/examples/ast-to-pdf-webfonts/assets/pipeline.js`
- `docs/examples/ast-to-pdf-webfonts/assets/ui.js`
- `docs/examples/ast-to-pdf-webfonts/fixtures/*.js` (built-in AST fixtures, loaded on demand)

## Run Locally (no web server)

Open `docs/examples/ast-to-pdf-webfonts/index.html` directly in a browser (`file://`).
...
- `/examples/ast-to-pdf-webfonts/index.html`

## Notes

- This example uses `WebFontManager` with remote font-byte loading and browser-side caching.
