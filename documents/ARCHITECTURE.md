...
For details on the intermediate representation that sets up the simulation board — style merging, layout track solving, and provenance mapping — see [SPATIAL-IR.md](SPATIAL-IR.md).
