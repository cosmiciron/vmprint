...
const DEFAULT_PRIMARY_FONT_REPOSITORY_BASE_URL = 'https://cdn.jsdelivr.net/npm/@vmprint/local-fonts@1.1.4/';
const DEFAULT_FALLBACK_FONT_REPOSITORY_BASE_URL = 'https://cdn.jsdelivr.net/npm/@vmprint/local-fonts@1.1.4/';
...
class PreviewSessionImpl implements PreviewSession {
    ...
    private async rebuild(documentInput: VmprintDocument): Promise<void> {
        const documentIr = loadDocument(documentInput as any, DEFAULT_DOCUMENT_PATH);
