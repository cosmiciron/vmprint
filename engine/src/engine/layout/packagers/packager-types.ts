...
export type PackagerRuntimeFormattingTarget = {
    sourceId?: string;
    actorId?: string;
    sourceStart?: number;
    sourceEnd?: number;
...
export type PackagerRuntimeSourcePath = {
    element: Element;
    ancestors: Element[];
};
...
export interface PackagerUnit {
    ...
    /**
     * Optional actor-owned source resolver for substructure whose stable
     * formatting identity is generated by the packager rather than authored
     * directly on the source tree.
     */
    resolveRuntimeFormattingSourcePath?(target: PackagerRuntimeFormattingTarget): PackagerRuntimeSourcePath | null | undefined;
